...
(function() {
    ...
    angular.module('cfp.hotkeys', []).provider('hotkeys', function() {
         ...
         * @type {String}
         */
        this.cheatSheetHotkey = 'ctrl+f1';

        /**
         * Configurable setting for the cheat sheet description
         * @type {String}
         */
        this.cheatSheetDescription = 'نمایش/عدم نمایش راهنمای صفحه کلید';
        ...
        this.$get = ['$rootElement', '$rootScope', '$compile', '$window', '$document', function ($rootElement, $rootScope, $compile, $window, $document) {
            ...
            //HACK: Changed by AliReza
            //This changed because of bug in persiting hot keys
            function purgeAllHotkeys() {
                var i = scope.hotkeys.length;
                while (i--) {
                    var hotkey = scope.hotkeys[i];
                    if (hotkey && hotkey.combo != this.cheatSheetHotkey) {
                        _del(hotkey);
                    }
                }
            }
            ...
            var publicApi = {
                ...
                purgeAllHotkeys          : purgeAllHotkeys
            };
